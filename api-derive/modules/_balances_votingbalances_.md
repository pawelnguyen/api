...
*Defined in [packages/api-derive/src/balances/votingBalances.ts:13](https://github.com/polkadot-js/api/blob/7a0efaf58c/packages/api-derive/src/balances/votingBalances.ts#L13)*
...
▸ (`addresses?`: string | AccountId‹› | AccountIndex‹› | Address‹›[]): *Observable‹DeriveBalancesAccount[]›*
