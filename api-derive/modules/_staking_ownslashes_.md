...
*Defined in [packages/api-derive/src/staking/ownSlashes.ts:13](https://github.com/polkadot-js/api/blob/844d1a2928/packages/api-derive/src/staking/ownSlashes.ts#L13)*
