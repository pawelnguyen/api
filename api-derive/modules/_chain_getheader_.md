...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/458b7fa7e4/packages/api-derive/src/chain/getHeader.ts#L27)*
