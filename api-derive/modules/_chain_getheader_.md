...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/94f81db568/packages/api-derive/src/chain/getHeader.ts#L27)*
