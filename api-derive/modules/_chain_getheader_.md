...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/3665690444/packages/api-derive/src/chain/getHeader.ts#L27)*
