...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/07c4037fcf/packages/api-derive/src/chain/getHeader.ts#L27)*
