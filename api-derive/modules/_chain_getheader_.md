...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/c8f91fcf7a/packages/api-derive/src/chain/getHeader.ts#L27)*
