...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/00490116dd/packages/api-derive/src/chain/getHeader.ts#L27)*
