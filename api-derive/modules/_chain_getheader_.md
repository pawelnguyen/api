...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/11e7b90918/packages/api-derive/src/chain/getHeader.ts#L27)*
