...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/174510a928/packages/api-derive/src/chain/getHeader.ts#L27)*
