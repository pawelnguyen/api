...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/2367978f6e/packages/api-derive/src/chain/getHeader.ts#L27)*
