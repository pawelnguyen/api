...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/a2269cd999/packages/api-derive/src/chain/getHeader.ts#L27)*
