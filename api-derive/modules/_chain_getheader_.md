...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/7e1fa8954b/packages/api-derive/src/chain/getHeader.ts#L27)*
