...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/98c7e5d5ea/packages/api-derive/src/chain/getHeader.ts#L27)*
