...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/7a0efaf58c/packages/api-derive/src/chain/getHeader.ts#L27)*
