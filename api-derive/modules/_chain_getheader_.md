...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/f5d2449407/packages/api-derive/src/chain/getHeader.ts#L27)*
