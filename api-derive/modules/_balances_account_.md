...
*Defined in [packages/api-derive/src/balances/account.ts:82](https://github.com/polkadot-js/api/blob/3665690444/packages/api-derive/src/balances/account.ts#L82)*
