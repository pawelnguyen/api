...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/844d1a2928/packages/api-derive/src/accounts/idToIndex.ts#L28)*
