...
*Defined in [packages/api-derive/src/staking/erasPrefs.ts:33](https://github.com/polkadot-js/api/blob/07c4037fcf/packages/api-derive/src/staking/erasPrefs.ts#L33)*
...
*Defined in [packages/api-derive/src/staking/erasPrefs.ts:25](https://github.com/polkadot-js/api/blob/07c4037fcf/packages/api-derive/src/staking/erasPrefs.ts#L25)*
...
*Defined in [packages/api-derive/src/staking/erasPrefs.ts:41](https://github.com/polkadot-js/api/blob/07c4037fcf/packages/api-derive/src/staking/erasPrefs.ts#L41)*
