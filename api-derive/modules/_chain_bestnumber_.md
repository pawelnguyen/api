...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/c8f91fcf7a/packages/api-derive/src/chain/bestNumber.ts#L25)*
