...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/05a834b822/packages/api-derive/src/chain/bestNumber.ts#L25)*
