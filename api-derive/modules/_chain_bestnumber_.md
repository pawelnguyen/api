...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/5a929d3810/packages/api-derive/src/chain/bestNumber.ts#L25)*
