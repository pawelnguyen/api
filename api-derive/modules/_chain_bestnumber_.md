...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/a2269cd999/packages/api-derive/src/chain/bestNumber.ts#L25)*
