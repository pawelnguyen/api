...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/1f8f6e54bd/packages/api-derive/src/session/eraLength.ts#L13)*
