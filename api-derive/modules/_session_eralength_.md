...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/98c7e5d5ea/packages/api-derive/src/session/eraLength.ts#L13)*
