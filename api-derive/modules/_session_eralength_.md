...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/7d1c93db59/packages/api-derive/src/session/eraLength.ts#L13)*
