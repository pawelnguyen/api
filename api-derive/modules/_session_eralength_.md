...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/07c4037fcf/packages/api-derive/src/session/eraLength.ts#L13)*
