...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/05a834b822/packages/api-derive/src/session/eraLength.ts#L13)*
