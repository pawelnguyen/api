...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/844d1a2928/packages/api-derive/src/session/eraLength.ts#L13)*
