...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/5b71abfe80/packages/api-derive/src/session/eraLength.ts#L13)*
