...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/664151f829/packages/api-derive/src/session/eraLength.ts#L13)*
