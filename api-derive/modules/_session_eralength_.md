...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/8c949bb3df/packages/api-derive/src/session/eraLength.ts#L13)*
