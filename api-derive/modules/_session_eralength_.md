...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/c8f91fcf7a/packages/api-derive/src/session/eraLength.ts#L13)*
