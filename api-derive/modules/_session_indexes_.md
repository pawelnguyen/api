...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/07c4037fcf/packages/api-derive/src/session/indexes.ts#L78)*
