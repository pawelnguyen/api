...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/5c16b8e8a1/packages/api-derive/src/session/indexes.ts#L78)*
