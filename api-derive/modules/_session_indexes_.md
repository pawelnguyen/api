...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/05a834b822/packages/api-derive/src/session/indexes.ts#L78)*
