...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/a135abaea2/packages/api-derive/src/session/indexes.ts#L78)*
