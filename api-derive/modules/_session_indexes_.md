...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/fb08215e0d/packages/api-derive/src/session/indexes.ts#L78)*
