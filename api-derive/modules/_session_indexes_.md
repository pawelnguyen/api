...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/932122cd21/packages/api-derive/src/session/indexes.ts#L78)*
