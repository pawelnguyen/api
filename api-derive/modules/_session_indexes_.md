...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/04c8d49e9d/packages/api-derive/src/session/indexes.ts#L78)*
