...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/7a0efaf58c/packages/api-derive/src/session/indexes.ts#L78)*
