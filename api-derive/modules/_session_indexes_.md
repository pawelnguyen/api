...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/7c8b2abf92/packages/api-derive/src/session/indexes.ts#L78)*
