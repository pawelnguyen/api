...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/458b7fa7e4/packages/api-derive/src/session/indexes.ts#L78)*
