...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/8c949bb3df/packages/api-derive/src/session/indexes.ts#L78)*
