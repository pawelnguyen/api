...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/fa9c5778be/packages/api-derive/src/session/indexes.ts#L78)*
