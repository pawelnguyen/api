...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/5c35a70e9d/packages/api-derive/src/session/indexes.ts#L78)*
