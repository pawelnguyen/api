...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/ccfab75f41/packages/api-derive/src/session/indexes.ts#L78)*
