...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/401784b7e6/packages/api-derive/src/session/indexes.ts#L78)*
