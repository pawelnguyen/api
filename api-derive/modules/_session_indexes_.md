...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/d1fae523ac/packages/api-derive/src/session/indexes.ts#L78)*
