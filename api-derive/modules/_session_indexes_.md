...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/9eb44d6e89/packages/api-derive/src/session/indexes.ts#L78)*
