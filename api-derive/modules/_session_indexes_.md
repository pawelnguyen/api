...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/475cb4fa69/packages/api-derive/src/session/indexes.ts#L78)*
