...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/a1ad90c2b4/packages/api-derive/src/session/indexes.ts#L78)*
