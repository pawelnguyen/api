...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/8676f30cbf/packages/api-derive/src/session/indexes.ts#L78)*
