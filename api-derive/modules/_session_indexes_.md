...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/a3eaca0270/packages/api-derive/src/session/indexes.ts#L78)*
