...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/7d1c93db59/packages/api-derive/src/session/indexes.ts#L78)*
