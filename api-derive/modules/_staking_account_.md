...
*Defined in [packages/api-derive/src/staking/account.ts:76](https://github.com/polkadot-js/api/blob/9387103558/packages/api-derive/src/staking/account.ts#L76)*
