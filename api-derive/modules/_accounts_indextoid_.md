...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/7e1fa8954b/packages/api-derive/src/accounts/indexToId.ts#L51)*
