...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/844d1a2928/packages/api-derive/src/accounts/indexToId.ts#L51)*
