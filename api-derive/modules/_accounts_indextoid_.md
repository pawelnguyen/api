...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/25393cd982/packages/api-derive/src/accounts/indexToId.ts#L51)*
