...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/9387103558/packages/api-derive/src/accounts/indexToId.ts#L51)*
