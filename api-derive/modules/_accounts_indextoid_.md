...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/f81712343a/packages/api-derive/src/accounts/indexToId.ts#L51)*
