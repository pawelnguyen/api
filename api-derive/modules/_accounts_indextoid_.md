...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/07c4037fcf/packages/api-derive/src/accounts/indexToId.ts#L51)*
