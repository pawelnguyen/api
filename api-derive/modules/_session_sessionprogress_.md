...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/5a929d3810/packages/api-derive/src/session/sessionProgress.ts#L13)*
