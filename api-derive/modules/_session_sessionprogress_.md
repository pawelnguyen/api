...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/a3eaca0270/packages/api-derive/src/session/sessionProgress.ts#L13)*
