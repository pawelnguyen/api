...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/7c8b2abf92/packages/api-derive/src/session/sessionProgress.ts#L13)*
