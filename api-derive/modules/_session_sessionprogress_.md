...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/d3d3bb9b5a/packages/api-derive/src/session/sessionProgress.ts#L13)*
