...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/102a06b0f2/packages/api-derive/src/session/sessionProgress.ts#L13)*
