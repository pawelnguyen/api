...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/f81712343a/packages/api-derive/src/session/sessionProgress.ts#L13)*
