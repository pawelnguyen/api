...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/d1fae523ac/packages/api-derive/src/session/sessionProgress.ts#L13)*
