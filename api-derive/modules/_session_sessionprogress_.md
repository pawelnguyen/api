...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/eae573e6a2/packages/api-derive/src/session/sessionProgress.ts#L13)*
