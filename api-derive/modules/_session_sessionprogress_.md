...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/7a0efaf58c/packages/api-derive/src/session/sessionProgress.ts#L13)*
