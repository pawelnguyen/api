...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/401784b7e6/packages/api-derive/src/session/sessionProgress.ts#L13)*
