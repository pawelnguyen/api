...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/226426e67e/packages/api-derive/src/session/sessionProgress.ts#L13)*
