...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/fa9c5778be/packages/api-derive/src/session/sessionProgress.ts#L13)*
