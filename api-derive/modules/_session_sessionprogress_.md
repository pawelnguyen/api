...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/174510a928/packages/api-derive/src/session/sessionProgress.ts#L13)*
