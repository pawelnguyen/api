...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/33165e93dc/packages/api-derive/src/session/sessionProgress.ts#L13)*
