...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/abd860d548/packages/api-derive/src/session/sessionProgress.ts#L13)*
