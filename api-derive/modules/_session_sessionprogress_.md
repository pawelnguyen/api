...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/c35f31bfbd/packages/api-derive/src/session/sessionProgress.ts#L13)*
