...
*Defined in [packages/api-derive/src/democracy/referendums.ts:13](https://github.com/polkadot-js/api/blob/f81712343a/packages/api-derive/src/democracy/referendums.ts#L13)*
