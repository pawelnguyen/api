...
*Defined in [packages/api-derive/src/democracy/referendums.ts:13](https://github.com/polkadot-js/api/blob/07c4037fcf/packages/api-derive/src/democracy/referendums.ts#L13)*
