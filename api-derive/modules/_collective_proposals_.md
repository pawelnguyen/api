...
*Defined in [packages/api-derive/src/collective/proposals.ts:31](https://github.com/polkadot-js/api/blob/7e1fa8954b/packages/api-derive/src/collective/proposals.ts#L31)*
