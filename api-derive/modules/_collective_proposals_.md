...
*Defined in [packages/api-derive/src/collective/proposals.ts:31](https://github.com/polkadot-js/api/blob/98c7e5d5ea/packages/api-derive/src/collective/proposals.ts#L31)*
