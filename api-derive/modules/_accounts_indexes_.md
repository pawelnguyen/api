...
*Defined in [packages/api-derive/src/accounts/indexes.ts:72](https://github.com/polkadot-js/api/blob/25393cd982/packages/api-derive/src/accounts/indexes.ts#L72)*
