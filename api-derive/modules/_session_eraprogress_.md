...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/a3eaca0270/packages/api-derive/src/session/eraProgress.ts#L13)*
