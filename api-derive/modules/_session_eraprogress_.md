...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/d1fae523ac/packages/api-derive/src/session/eraProgress.ts#L13)*
