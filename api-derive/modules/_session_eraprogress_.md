...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/cdfbf91ee6/packages/api-derive/src/session/eraProgress.ts#L13)*
