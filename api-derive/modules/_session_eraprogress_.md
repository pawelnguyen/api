...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/d3d3bb9b5a/packages/api-derive/src/session/eraProgress.ts#L13)*
