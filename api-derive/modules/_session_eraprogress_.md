...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/3de09a2e27/packages/api-derive/src/session/eraProgress.ts#L13)*
