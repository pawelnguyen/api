...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/c70cdb351f/packages/api-derive/src/session/eraProgress.ts#L13)*
