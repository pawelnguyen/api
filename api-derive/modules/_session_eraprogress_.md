...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/98c7e5d5ea/packages/api-derive/src/session/eraProgress.ts#L13)*
