...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/ccfab75f41/packages/api-derive/src/session/eraProgress.ts#L13)*
