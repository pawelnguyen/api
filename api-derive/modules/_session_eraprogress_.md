...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/102a06b0f2/packages/api-derive/src/session/eraProgress.ts#L13)*
