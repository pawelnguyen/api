...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/8aa1bd5bd0/packages/api-derive/src/session/eraProgress.ts#L13)*
