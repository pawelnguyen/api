...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/d75d8bec0e/packages/api-derive/src/session/eraProgress.ts#L13)*
