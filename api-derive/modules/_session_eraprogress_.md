...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/401784b7e6/packages/api-derive/src/session/eraProgress.ts#L13)*
