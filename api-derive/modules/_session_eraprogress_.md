...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/04c8d49e9d/packages/api-derive/src/session/eraProgress.ts#L13)*
