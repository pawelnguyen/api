...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/fa9c5778be/packages/api-derive/src/session/eraProgress.ts#L13)*
