...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/5c16b8e8a1/packages/api-derive/src/session/eraProgress.ts#L13)*
