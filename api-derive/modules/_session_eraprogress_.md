...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/fb08215e0d/packages/api-derive/src/session/eraProgress.ts#L13)*
