...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/07c4037fcf/packages/api-derive/src/session/eraProgress.ts#L13)*
