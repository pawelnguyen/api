...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/426aef6088/packages/api-derive/src/session/eraProgress.ts#L13)*
