...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/7e1fa8954b/packages/api-derive/src/session/eraProgress.ts#L13)*
