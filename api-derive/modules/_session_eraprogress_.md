...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/e3d3a1ff71/packages/api-derive/src/session/eraProgress.ts#L13)*
