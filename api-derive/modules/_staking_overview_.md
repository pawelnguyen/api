...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/c8f91fcf7a/packages/api-derive/src/staking/overview.ts#L16)*
