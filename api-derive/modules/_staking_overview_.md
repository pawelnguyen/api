...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/a2269cd999/packages/api-derive/src/staking/overview.ts#L16)*
