...
*Defined in [rx/RxBlueprint.ts:14](https://github.com/polkadot-js/api/blob/844d1a2928/packages/api-contract/src/rx/RxBlueprint.ts#L14)*
...
*Defined in [base/Blueprint.ts:38](https://github.com/polkadot-js/api/blob/844d1a2928/packages/api-contract/src/base/Blueprint.ts#L38)*
...
*Defined in [base/Blueprint.ts:46](https://github.com/polkadot-js/api/blob/844d1a2928/packages/api-contract/src/base/Blueprint.ts#L46)*
