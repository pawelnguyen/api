...
*Defined in [promise/PromiseCode.ts:13](https://github.com/polkadot-js/api/blob/98c7e5d5ea/packages/api-contract/src/promise/PromiseCode.ts#L13)*
...
*Defined in [base/Code.ts:39](https://github.com/polkadot-js/api/blob/98c7e5d5ea/packages/api-contract/src/base/Code.ts#L39)*
...
*Defined in [base/Code.ts:47](https://github.com/polkadot-js/api/blob/98c7e5d5ea/packages/api-contract/src/base/Code.ts#L47)*
