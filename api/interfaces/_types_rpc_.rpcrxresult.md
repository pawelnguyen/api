...
*Defined in [api/src/types/base.ts:48](https://github.com/polkadot-js/api/blob/8aa1bd5bd0/packages/api/src/types/base.ts#L48)*
...
*Defined in [api/src/types/base.ts:49](https://github.com/polkadot-js/api/blob/8aa1bd5bd0/packages/api/src/types/base.ts#L49)*
...
*Defined in [api/src/types/rpc.ts:12](https://github.com/polkadot-js/api/blob/8aa1bd5bd0/packages/api/src/types/rpc.ts#L12)*
