...
*Defined in [api/src/types/storage.ts:74](https://github.com/polkadot-js/api/blob/3de09a2e27/packages/api/src/types/storage.ts#L74)*
...
*Defined in [api/src/types/storage.ts:75](https://github.com/polkadot-js/api/blob/3de09a2e27/packages/api/src/types/storage.ts#L75)*
