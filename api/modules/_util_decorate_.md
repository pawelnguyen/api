...
*Defined in [api/src/util/decorate.ts:13](https://github.com/polkadot-js/api/blob/52ccb9fbbf/packages/api/src/util/decorate.ts#L13)*
...
*Defined in [api/src/util/decorate.ts:46](https://github.com/polkadot-js/api/blob/52ccb9fbbf/packages/api/src/util/decorate.ts#L46)*
