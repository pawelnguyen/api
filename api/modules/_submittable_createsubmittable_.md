...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/a2269cd999/packages/api/src/submittable/createSubmittable.ts#L17)*
