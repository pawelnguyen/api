...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/458b7fa7e4/packages/api/src/submittable/createSubmittable.ts#L17)*
