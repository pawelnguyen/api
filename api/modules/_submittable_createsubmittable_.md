...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/932122cd21/packages/api/src/submittable/createSubmittable.ts#L17)*
