...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/07c4037fcf/packages/api/src/submittable/createSubmittable.ts#L17)*
