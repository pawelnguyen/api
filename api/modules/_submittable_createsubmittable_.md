...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/7a0efaf58c/packages/api/src/submittable/createSubmittable.ts#L17)*
