...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/94f81db568/packages/api/src/submittable/createSubmittable.ts#L17)*
