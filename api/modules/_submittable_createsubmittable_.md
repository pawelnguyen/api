...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/844d1a2928/packages/api/src/submittable/createSubmittable.ts#L17)*
