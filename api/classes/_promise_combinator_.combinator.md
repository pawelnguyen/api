...
*Defined in [api/src/promise/Combinator.ts:29](https://github.com/polkadot-js/api/blob/4a497fa970/packages/api/src/promise/Combinator.ts#L29)*
...
*Defined in [api/src/promise/Combinator.ts:77](https://github.com/polkadot-js/api/blob/4a497fa970/packages/api/src/promise/Combinator.ts#L77)*
