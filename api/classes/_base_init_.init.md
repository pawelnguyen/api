...
*Defined in [api/src/base/Init.ts:25](https://github.com/polkadot-js/api/blob/94f81db568/packages/api/src/base/Init.ts#L25)*
...
*Defined in [api/src/base/Decorate.ts:163](https://github.com/polkadot-js/api/blob/94f81db568/packages/api/src/base/Decorate.ts#L163)*
