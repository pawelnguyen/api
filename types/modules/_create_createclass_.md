...
*Defined in [packages/types/src/create/createClass.ts:43](https://github.com/polkadot-js/api/blob/f81712343a/packages/types/src/create/createClass.ts#L43)*
...
*Defined in [packages/types/src/create/createClass.ts:38](https://github.com/polkadot-js/api/blob/f81712343a/packages/types/src/create/createClass.ts#L38)*
...
*Defined in [packages/types/src/create/createClass.ts:30](https://github.com/polkadot-js/api/blob/f81712343a/packages/types/src/create/createClass.ts#L30)*
...
*Defined in [packages/types/src/create/createClass.ts:178](https://github.com/polkadot-js/api/blob/f81712343a/packages/types/src/create/createClass.ts#L178)*
