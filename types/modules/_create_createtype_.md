...
*Defined in [packages/types/src/create/createType.ts:76](https://github.com/polkadot-js/api/blob/426aef6088/packages/types/src/create/createType.ts#L76)*
...
*Defined in [packages/types/src/create/createType.ts:60](https://github.com/polkadot-js/api/blob/426aef6088/packages/types/src/create/createType.ts#L60)*
