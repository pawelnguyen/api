...
import { ApiId, KeyValueOption, PairResult, RuntimeVersion, RuntimeVersionApi, StorageChangeSet } from '@polkadot/types/interfaces/state';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Option<PairResult>': Option<PairResult>;
    'Vec<PairResult>': Vec<PairResult>;
